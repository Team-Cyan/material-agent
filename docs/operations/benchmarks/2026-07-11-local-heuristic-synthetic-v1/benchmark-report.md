...
| `embedding_same_group_top1` | n/a |
| `embedding_non_photo_photo_max_similarity` | n/a |
| `face_recall` | n/a |
| `face_accuracy` | n/a |
...
| --- | --- | ---: | --- | --- |
| `portrait-sharp` | `portrait-burst-001` | 6.7471 | `other` | `heuristic` |
| `portrait-motion-blur` | `portrait-burst-001` | 6.6757 | `other` | `heuristic` |
| `low-light-room` | `low-light-001` | 4.6686 | `other` | `heuristic` |
| `ui-screenshot` | `non-photo-001` | 3.8729 | `other` | `heuristic` |
